...
header file of the CSha1Ex class anymore.
...
- CSha1Ex now compiles fine with GCC 3.3 under Mac OS X (thanks to Larry
Hastings).

Version 1.3 - 2003-08-17
- Fixed a small memory bug and made a buffer array a class member to
ensure correct working when using multiple CSha1Ex class instances at
one time.
...
not to work properly. CSha1Ex is now Borland compatible.
