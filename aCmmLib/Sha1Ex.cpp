...
void CSha1Ex::Transform(UINT_32* pState, const UINT_8* pBuffer)
{
...
void CSha1Ex::Update(const UINT_8* pbData, UINT_32 uLen)
{
...
bool CSha1Ex::HashFile(const TCHAR* tszFileName)
{
...
#ifdef SHA1_UTILITY_FUNCTIONS
bool CSha1Ex::ReportHash(TCHAR* tszReport, REPORT_TYPE rtReportType) const
{
...
bool CSha1Ex::ReportHashStl(std::basic_string<TCHAR>& strOut, REPORT_TYPE rtReportType) const
{
	TCHAR tszOut[84];
...
bool CSha1Ex::GetHash(UINT_8* pbDest20) const
{
