...
BOOL ZipAddFile(zipFile zf, LPCTSTR lpszFileNameInZip, LPCTSTR lpszFilePath, bool bUtf8 = true)
{
...
BOOL ZipAddFiles(zipFile zf, LPCTSTR lpszFileNameInZip, LPCTSTR lpszFiles, bool bUtf8 = true)
{
    WIN32_FIND_DATA wfd;
...
BOOL ZipCompress(LPCTSTR lpszSourceFiles, LPCTSTR lpszDestFile, bool bUtf8 /*= true*/)
{
	...
	zipFile zf = zipOpen2_64(lpszDestFile, 0, NULL, &zlib_filefunc_def);
#else
...
BOOL ZipExtract(LPCTSTR lpszSourceFile, LPCTSTR lpszDestFolder)
{
	...
	zlib_filefunc64_def zlib_filefunc_def;
	fill_win32_filefunc64(&zlib_filefunc_def);
    unzFile uf = unzOpen2_64(lpszSourceFile, &zlib_filefunc_def);
#else
