...
public:
	...
	void Align(long AlignCmd, long RelativeTo)
	{
		...
		InvokeHelper(0x7e2, DISPATCH_METHOD, VT_EMPTY, NULL, parms, AlignCmd, RelativeTo);
	}
	void Distribute(long DistributeCmd, long RelativeTo)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x7e3, DISPATCH_METHOD, VT_EMPTY, NULL, parms, DistributeCmd, RelativeTo);
	}
	void GetPolygonalRepresentation(unsigned long maxPointsInBuffer, float * pPoints, unsigned long * numPointsInPolygon, long * IsOpen)
	{
		static BYTE parms[] = VTS_UI4 VTS_PR4 VTS_PUI4 VTS_PI4 ;
		InvokeHelper(0x7e4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, maxPointsInBuffer, pPoints, numPointsInPolygon, IsOpen);
	}
	...
	void Export(LPCTSTR PathName, long Filter, long ScaleWidth, long ScaleHeight, long ExportMode)
	{
		...
		InvokeHelper(0x7e7, DISPATCH_METHOD, VT_EMPTY, NULL, parms, PathName, Filter, ScaleWidth, ScaleHeight, ExportMode);
	}
	long get_HasDiagram()
	{
		long result;
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x7eb, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	...
	void ApplyAnimation()
	{
		InvokeHelper(0x7ed, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void UpgradeMedia()
	{
		InvokeHelper(0x7ee, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
