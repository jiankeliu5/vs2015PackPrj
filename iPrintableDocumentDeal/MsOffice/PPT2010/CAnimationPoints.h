...
// CAnimationPoints 包装类

class CAnimationPoints : public COleDispatchDriver
{
public:
	CAnimationPoints(){} // 调用 COleDispatchDriver 默认构造函数
	CAnimationPoints(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAnimationPoints(const CAnimationPoints& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
