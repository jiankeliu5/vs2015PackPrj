...
class CRows0 : public COleDispatchDriver
{
public:
	CRows0(){} // 调用 COleDispatchDriver 默认构造函数
	CRows0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CRows0(const CRows0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
