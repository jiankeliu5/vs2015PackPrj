...
class CApplication1 : public COleDispatchDriver
{
public:
	CApplication1(){} // 调用 COleDispatchDriver 默认构造函数
	CApplication1(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CApplication1(const CApplication1& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void get_VBE()
	{
		InvokeHelper(0x7e3, DISPATCH_PROPERTYGET, VT_EMPTY, NULL, NULL);
	}
