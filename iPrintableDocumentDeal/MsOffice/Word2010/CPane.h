...
class Xab_CPane : public COleDispatchDriver
{
public:
	Xab_CPane(){} // 调用 COleDispatchDriver 默认构造函数
	Xab_CPane(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	Xab_CPane(const Xab_CPane& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
